export const NFTProgramId = 'metaix_nft.aleo';

export const NFTProgram = `program metaix_nft.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo154g0gsqg9n3z2rlmtcuj8h8fyk9kah6wyuyawe979qngzzs9fqpsdf64f2;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as metaix_nft.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as metaix_nft.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as metaix_nft.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as metaix_nft.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as metaix_nft.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as metaix_nft.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as metaix_nft.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as metaix_nft.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as metaix_nft.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as metaix_nft.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as metaix_nft.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as metaix_nft.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as metaix_nft.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as metaix_nft.aleo/convert_public_to_private.future;
